...
def main(args):
    ...
    for dtype in dtype_ints:
        for reduce_op in reduce_ops:
            ...
            test_all_reduce(args, dtype, reduce_op)
...
def test_all_reduce(args, dtype, reduce_op):
    rank = dist.get_rank()
    ...
    print(f"Rank {rank} allreduce input: {tensor}, reduce op: {reduce_op}")
    dist.all_reduce(tensor, reduce_op)
    print(f"Rank {rank} allreduce received: {tensor}, reduce op: {reduce_op}")
