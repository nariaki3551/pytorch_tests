...
int main(int argc, char** argv) {
    ...
    for (size_t count = min_count; count <= max_count; count = static_cast<size_t>(count * step_factor)) {
        ...
        total_sent_words += static_cast<double>(count * sizeof(int) * ctx.size * rounds);
        total_received_words += static_cast<double>(count * sizeof(int) * rounds);
    }
